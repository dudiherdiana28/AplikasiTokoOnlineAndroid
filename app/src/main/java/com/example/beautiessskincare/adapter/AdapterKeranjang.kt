...
class AdapterKeranjang(var activity: Activity, var data:ArrayList<Produk>, var listener : Listener) : RecyclerView.Adapter<AdapterKeranjang.Holder> () {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.checkbok.isChecked = produk.selected
...
//        val image = "http://192.168.1.18/beautiess/public/storage/produk/"+data[position].image
...
//            notifyItemRemoved(position)
    ...
    private fun update(data: Produk) {
        var myDb = myDatabase.getInstance(activity)
